...
public class ViewAppointmentJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnGenerateBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 650, 162, -1));
        ...
        add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 650, 162, -1));
...
//            AppointmentStatus status = (AppointmentStatus)txtAppointmentStatus.getSelectedItem();
    ...
    private void btnGenerateBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillActionPerformed
        ...
        if(appointment != null && appointment.getBillObj() != null && appointment.getBillObj().getStatus().equals("Pending approval from Insurance"))
        {
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        ...
        appointment.getBillObj().setStatus("Close");
