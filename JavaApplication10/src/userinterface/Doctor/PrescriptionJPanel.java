   ...
   public PrescriptionJPanel(JPanel userProcessContainer, Patient patient, Appointment appointment, Employee doctor,
    ...
    void populatePharmacy(){
        ...
        for(int i=0;i<networkList.size();i++){
            ...
            List<Enterprise> enterpriseList= network.getEntDirectory().getEnterpriseList();
    ...
    void populateMedicineCmb()
    {
          ...
          for(Medicine med: medicineList1.getList())
          {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 70, 240, 35));
